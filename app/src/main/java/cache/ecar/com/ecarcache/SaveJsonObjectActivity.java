...
public class SaveJsonObjectActivity extends Activity {
	...
	public void read(View v) {
		mCache.getAsJSONObject("testJsonObject").subscribe(new Action1<JSONObject>() {
			@Override
			public void call(JSONObject testJsonObject) {
				if (testJsonObject == null) {
					Toast.makeText(SaveJsonObjectActivity.this, "JSONObject cache is null ...",
