...
public class SaveDrawableActivity extends Activity {
    ...
    public void read(View v) {
        ...
        mCache.getAsDrawable("testDrawable").subscribe(new Action1<Drawable>() {
            @Override
            public void call(Drawable testDrawable) {
                if (testDrawable == null) {
                    Toast.makeText(SaveDrawableActivity.this, "Drawable cache is null ...",
