...
public class SaveBitmapActivity extends Activity {
	...
	public void read(View v) {
		mCache.getAsBitmap("testBitmap").subscribe(new Action1<Bitmap>() {
			@Override
			public void call(Bitmap testBitmap) {
				if (testBitmap == null) {
					Toast.makeText(SaveBitmapActivity.this, "Bitmap cache is null ...", Toast.LENGTH_SHORT)
							.show();
