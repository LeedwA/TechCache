...
public class SaveJsonArrayActivity extends Activity {
    ...
    public void read(View v) {
        mCache.getAsJSONArray("testJsonArray").subscribe(new Action1<JSONArray>() {
            @Override
            public void call(JSONArray testJsonArray) {
                if (testJsonArray == null) {
                    Toast.makeText(SaveJsonArrayActivity.this, "JSONArray cache is null ...",
